...
favourite_movies, titles, genre, release_year
...
| Record                | Properties          |
| --------------------- | ------------------  |
| favourite_movies      | title, genre, release_year

Name of the table (always plural): `favourite_films` 
